...
return array(
    'system' => array('name' => '平台', 'child' => array(
        array('name' => '设置', 'child' => array(
            ...
            array('name' => '国家管理', 'act' => 'country', 'op' => 'Tools'),
    ...
    'shop' => array('name' => '商城', 'child' => array(
        array('name' => '商品', 'child' => array(
            ...
            array('name' => '药品列表', 'act' => 'drugList', 'op' => 'Goods'),
        ...
        array('name' => '订单', 'child' => array(
            ...
            array('name' => '预约列表', 'act' => 'subscribe', 'op' => 'Order'),
        ...
        array('name' => '运营', 'child' => array(
		   ...
		   /******************dengxing begin********************/
            array('name' => '会员佣金提现申请', 'act' => 'user_withdrawals', 'op' => 'Finance'),
            /******************dengxing end*********************/
