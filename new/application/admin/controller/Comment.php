...
class Comment extends Base {
    ...
    public function ajaxindex(){
        ...
        $comment_list = Db::name('comment')->alias('c')->field('c.*,u.nickname as nickname,u.mobile')->join('__USERS__ u','u.user_id = c.user_id','LEFT')->where($where)->order('add_time DESC')->limit($Page->firstRow.','.$Page->listRows)->select();
