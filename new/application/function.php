 ...
 * @return mixed
 */
function httpCurl($url, $method = "GET", $postfields = null, $headers = array(), $debug = false)
{
    $method = strtoupper($method);
    $ci = curl_init();
    /* Curl settings */
    ...
    return array('http_code' => $http_code, 'respose_info' => $response, 'request_info' => $requestinfo);
}
