...
class Payment extends MobileBase
{
    ...
    public function __construct()
    {
        ...
        if (empty($this->pay_code))
            $this->redirect(U('mobile/User/order_list'));
        // 导入具体的支付类文件
    ...
    public function getCode()
    {
        ...
        echo "pay_code:".$config_value['pay_code']."++++++";*/
        switch ($config_value['pay_code']) {
            case 'weixinAppPatientsPay':
            case 'weixinAppDoctorPay':
                $page = (in_array($this->app_type, array(1, 3))) ? 'iosAppWeixinPay' : 'androidAppWeixinPay';
                $code_str = json_encode($code_str);
                break;
			case 'alipayAppPatientsPay':
            case 'alipayAppDoctorPay':
                $page = (in_array($this->app_type, array(1, 3))) ? 'iosAppAliPay' : 'androidAppAliPay';
                $code_str = json_encode($code_str);
                break;
            default:
                $page = 'payment';
        }
        /*echo "code_str:".$code_str."++++++";
        echo "pay:".$page."++++++";
        exit;*/
        $this->assign('code_str', $code_str);
        $this->assign('order_id', $order_id);
        $this->assign('master_order_sn', $master_order_sn); // 主订单号
        return $this->fetch($page);  // 分跳转 和不 跳转
    }
    ...
    public function notifyUrl()
    {
        ...
        /*$content = M('pay_respose')->where('pay_respose_id=6')->getField('content');
        $respose = unserialize($content);
        $_POST = $respose;
        /*print_r($respose);die;*/
    ...
    {
        //http://m.yzjapp.com/index.php/Home/Payment/returnUrl/pay_code/alipayWap?total_amount=0.01&timestamp=2017-06-21+11%3A32%3A56&sign=e5Vhgv4ucOkjNcXVy3QHBkb3eWTQ6yW4qMD7qPdkuXTFHsKcmNlS3QnFYzrkO7HAI5Bo5dxvfbykSp%2FcQxxe%2Fbv1Txew02KkVXDZcsjDYcDsNWXiB5NYGb%2ByvCGfC%2BEC8E2%2B%2Bv4yHPTRkaLK5Hr%2BrU1pJstt%2BWaGtG%2Fr1yQpVzkyGUJpXJE88Uvjef%2B5FQbtCfGAGtoDzZBImTpKQHWGcxPRkVHsERVIc7%2B8Cmpf9jrnnF%2FYLoFJG2KcfSPSql6D2Ogm2srCU2lVqn765yusM%2FpiLoE%2FAneaNYlAnueUNiMvjjnx%2FmuWCcEacVJopmBOrs3MTUkcM6XKMQrzDULqRg%3D%3D&trade_no=2017062121001004080205322940&sign_type=RSA2&auth_app_id=2017061407489692&charset=UTF-8&seller_id=2088721131209114&method=alipay.trade.wap.pay.return&app_id=2017061407489692&out_trade_no=201706211132231283&version=1.0
