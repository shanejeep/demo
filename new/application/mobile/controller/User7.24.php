    ...
    */
    public function _initialize()
    {
        ...
        $nologin = array(
            ...
            'verifyHandle', 'reg', 'send_sms_reg_code', 'bind_mobile','find_pwd', 'check_validate_code',
    ...
    public function add_address()
    {
        if (IS_POST) {
            ...
            elseif (I('source','') == 'cart2') {
                header('Location:' . U('/Mobile/Cart/cart2', array('address_id' => $data['result'],'s'=>I('s'))));
                exit;
            }
            elseif (I('source','') == 'order_preview') {
                header('Location:' . U('/Mobile/Cart/order_preview', array('address_id' => $data['result'],'s'=>I('s'))));
                exit;
            }
            /*-------deng end-------*/
    ...
    public function edit_address()
    {
        ...
        if (IS_POST) {
            ...
            /*------deng start------*/
            if (I('source','') == 'cart2') {
                header('Location:' . U('/Mobile/Cart/cart2', array('address_id' => $id, 's' => $s)));
                exit;
            }elseif (I('source','') == 'order_preview') {
