...
class WxPayApi
{
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function myunifiedOrder($inputObj, $timeOut = 6)
	{
		// $url = "https://api.mch.weixin.qq.com/pay/unifiedorder";
		// //检测必填参数
		// if(!$inputObj->IsOut_trade_noSet()) {
        ...
        $input->SetOpenid($openId);
            ...
            $input->Setscene_info('{"h5_info": {"type":"Wap","wap_url": "http://shop.yzjia.com","wap_name": "购买商品"}}');
        

			
			$mySign=$input->SetSign();
		    //$xml = $inputObj->ToXml();
			
            $this->sign = $this->MyMakeSign( $this->params );
            $this->params['sign'] = $mySign;//$this->sign;
			
			echo 'mySign:'.$mySign;
			echo 'this->sign:'.$this->sign;
			exit();
	  ...
	  /**
         ...
         *  @return 签名
         */
        public function MyMakeSign( $params ){
            //签名步骤一：按字典序排序数组参数
            ksort($params);
