 ...
 * Class appWeixinPay
 */
class weixinAppPatientsPay extends Model
{
    ...
    {
        $paymentPlugin = M('Plugin')->where("code='weixinAppPatientsPay' and  type = 'payment' ")->find(); // 找到支付插件的配置
    ...
    function get_code($order)
    {
        ...
        if ($res['return_code'] == 'FAIL' || !$res['prepay_id']) {
            return false;
        }
