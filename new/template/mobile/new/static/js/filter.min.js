var bizFilter = {
	...
	bindToggle: function(a) {
		...
		$(".filtrate_category,.filtrate_category_a", a).click(function() {
			$(this).hasClass("filtrate_category_show") ? ($(this).parent().removeClass("fixed"), $(this).parent().next(".filtrate_list").css("margin-top", "0").hide(), $(this).removeClass("filtrate_category_show")) : ($(this).parent().removeClass("fixed"), $(this).parent().next(".filtrate_list").show(), $(this).addClass("filtrate_category_show"), $(this).parent().next(".filtrate_list").find("li").show())
		})
	},
